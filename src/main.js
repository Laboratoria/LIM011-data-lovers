...
const pantallaPokemonCaramelo= document.getElementById('caramelo-muestra-name-picture-pokemon');
const botonLimpiarCaramelos=document.getElementById('btn-limpiar-caramelos');
botonDescubrir.addEventListener('click',()=>{
document.getElementById('caramelo-muestra-name-picture-pokemon').innerHTML = showNamePicturePokemon(POKEMON);
pantallaPokemonCaramelo.style.display='block';
})
botonLimpiarCaramelos.addEventListener('click',()=>{
document.getElementById('caramelo-muestra-name-picture-pokemon').innerHTML = '';
